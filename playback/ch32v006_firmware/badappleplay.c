...
#include "lib_rand.h"
	...
	__attribute__((section(".text")))  const uint8_t ssd1306_init_array[] =
	{
		0xAE, // Display off
...
__attribute__((section(".text"))) const uint8_t framestart[] = {0xD3, 0x32, 0xA8, 0x01,
...
__attribute__((section(".text"))) const uint8_t frameend[] = {0xD3, 0x3e, 0xA8, 0x31};
